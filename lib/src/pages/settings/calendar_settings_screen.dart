...
class _CalendarSettingsScreenState extends State<CalendarSettingsScreen> {
  ...
  Widget build(BuildContext context) {
    return SettingsSubPageScaffold(
      ...
      slivers: [
        SliverToBoxAdapter(
          child: Padding(padding: const EdgeInsets.symmetric(horizontal: 18), child: CalendarEntitiesCard(saveController: _saveController)),
        ),
      ],
    );
  }
